...
LOGGING = {
    ...
    'formatters': {
        # Human-readable formatter with timestamps, log level, logger name, and message.
        'verbose': {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'chat.log',  # Log file name (placed in your project root).
            'formatter': 'verbose',  # Use the human-readable formatter.
        },
        'console': {
            'level': 'DEBUG',
    ...
    'loggers': {
        # Logger for your chat application.
        'chat': {
            'handlers': ['file', 'console'],
            'level': 'DEBUG',
            'propagate': True,
        },
        # You can also add a logger for Django if needed.
        'django': {
            'handlers': ['console'],
            'level': 'INFO',
            'propagate': False,
